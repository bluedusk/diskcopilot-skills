...
Use the template below. Follow this format exactly — the visual structure matters. Use unicode bars and clean alignment to make it scannable at a glance.
...
[bar showing used vs free, e.g.]
[===================>          ] 72% used
 185 GB used / 228 GB total / 43 GB free

## Storage Breakdown

  43.6 GB  ████████████░░░░░░░░  37.8%  Library
  29.5 GB  ████████░░░░░░░░░░░░  25.5%  playground
   9.1 GB  ██░░░░░░░░░░░░░░░░░░   7.8%  .npm
   8.6 GB  ██░░░░░░░░░░░░░░░░░░   7.4%  Downloads
   8.0 GB  ██░░░░░░░░░░░░░░░░░░   6.9%  Documents
   ...

## Cleanup Opportunities

### Safe to delete — 45.9 GB recoverable
Build artifacts and caches. Regenerated automatically by build commands.

  21.9 GB  target/           11 dirs    cargo build
  14.7 GB  node_modules/   5983 dirs    npm install
   2.9 GB  dist/           3669 dirs    npm run build
   2.3 GB  .next/            13 dirs    npm run build
   ...
  ─────────────────────────────────────
  45.9 GB  total recoverable

### Review before deleting — ~5 GB
Old files, forgotten downloads. Look before you trash.

   1.4 GB  VID_20230818_122637.mp4     2+ years old
   1.4 GB  01-05.tar                   archive, likely extracted
   730 MB  ~/xxx                       unknown file, 2+ years old
   ...

### macOS system junk — ~3 GB
Browser caches, app update leftovers, package manager caches.

   1.9 GB  Chrome cache           Clear in Chrome settings
   812 MB  VSCode update cache    Safe to delete
   638 MB  Mozilla update cache   Safe to delete
   296 MB  Homebrew cache         brew cleanup
   ...

### App-managed data — 15+ GB (don't delete manually)
   8.3 GB  claudevm.bundle    Needed for Claude Code
   4.3 GB  Chrome AI model    Disable in Chrome flags if unwanted
   2.9 GB  Docker.raw         Shrink: docker system prune -a

## Quick Wins

 1. cargo clean in 3 projects               -21.9 GB
 2. npm cache clean --force                   -9.1 GB
 3. Delete inactive node_modules             -14.7 GB
 4. brew cleanup && clear browser caches      -3.0 GB
 5. Trash old DMGs in Downloads               -1.0 GB
                                       ─────────────
                                  Total  ~50 GB freed
```
...
Health score grades:
- A (>40% free): Healthy
- B (20-40% free): Good shape
- C (10-20% free): Getting tight
- D (5-10% free): Low space
- F (<5% free): Critical
